...
class CrearRecetaPasabocasActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_crear_receta_pasabocas)

        // Inicializar los elementos de la interfaz de usuario
        editTextNombreReceta = findViewById(R.id.editTextNombreRecetaPasabocas)
        editTextUtensilios = findViewById(R.id.editTextUtensiliosPasabocas)
        editTextTiempoAproximado = findViewById(R.id.editTextTiempoAproximadoPasabocas)
        editTextIngredientes = findViewById(R.id.editTextIngredientesPasabocas)
        editTextPreparacion = findViewById(R.id.editTextPreparacionPasabocas)
        editTextConsejos = findViewById(R.id.editTextConsejoPasabocas)
        imageViewFotoFinal = findViewById(R.id.imageViewFotoFinalPasabocas)
        buttonGuardarReceta = findViewById(R.id.buttonGuardarRecetaPasabocas)
    ...
    private fun guardarReceta() {
        ...
        if (nombre.isBlank() || utensilios.isBlank() || tiempoAproximado.isBlank() || ingredientes.isBlank() || preparacion.isBlank()) {
            ...
            if (result != -1L) {
                Toast.makeText(this, "Receta de pasabocas guardada exitosamente", Toast.LENGTH_LONG).show()
            } else {
