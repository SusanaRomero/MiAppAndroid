...
class BuscarRecetasEnsaladasActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_buscar_recetas_ensaladas)

        recyclerView = findViewById(R.id.recyclerViewBuscarRecetaEnsaladas)
        recyclerView.layoutManager = LinearLayoutManager(this)

        databaseHelper = DatabaseHelper(this)
        val listaRecetas = databaseHelper.getRecetasByTipo("Ensaladas")
