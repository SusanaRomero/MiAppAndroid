...
class CrearRecetaSopasActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_crear_receta_sopas)

        // Inicializar los elementos de la interfaz de usuario
        editTextNombreReceta = findViewById(R.id.editTextNombreRecetaSopas)
        editTextUtensilios = findViewById(R.id.editTextUtensiliosSopas)
        editTextTiempoAproximado = findViewById(R.id.editTextTiempoAproximadoSopas)
        editTextIngredientes = findViewById(R.id.editTextIngredientesSopas)
        editTextPreparacion = findViewById(R.id.editTextPreparacionSopas)
        editTextConsejos = findViewById(R.id.editTextConsejoSopas)
        imageViewFotoFinal = findViewById(R.id.imageViewFotoFinalSopas)
        buttonGuardarReceta = findViewById(R.id.buttonGuardarRecetaSopas)
    ...
    private fun guardarReceta() {
        ...
        if (nombre.isBlank() || utensilios.isBlank() || tiempoAproximado.isBlank() || ingredientes.isBlank() || preparacion.isBlank()) {
            ...
            if (result != -1L) {
                Toast.makeText(this, "Receta de Sopas guardada exitosamente", Toast.LENGTH_LONG).show()
            } else {
