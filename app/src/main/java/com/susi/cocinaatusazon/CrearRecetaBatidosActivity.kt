...
class CrearRecetaBatidosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_crear_receta_batidos)

        // Inicializar los elementos de la interfaz de usuario
        editTextNombreReceta = findViewById(R.id.editTextNombreRecetaBatidos)
        editTextUtensilios = findViewById(R.id.editTextUtensiliosBatidos)
        editTextTiempoAproximado = findViewById(R.id.editTextTiempoAproximadoBatidos)
        editTextIngredientes = findViewById(R.id.editTextIngredientesBatidos)
        editTextPreparacion = findViewById(R.id.editTextPreparacionBatidos)
        editTextConsejos = findViewById(R.id.editTextConsejoBatidos)
        imageViewFotoFinal = findViewById(R.id.imageViewFotoFinalBatidos)
        buttonGuardarReceta = findViewById(R.id.buttonGuardarRecetaBatidos)
    ...
    private fun guardarReceta() {
        ...
        if (nombre.isBlank() || utensilios.isBlank() || tiempoAproximado.isBlank() || ingredientes.isBlank() || preparacion.isBlank()) {
            ...
            if (result != -1L) {
                Toast.makeText(this, "Receta de Batidos guardada exitosamente", Toast.LENGTH_LONG).show()
            } else {
