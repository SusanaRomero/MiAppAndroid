...
class BuscarRecetasPastaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_buscar_recetas_pasta)

        recyclerView = findViewById(R.id.recyclerViewBuscarRecetaPasta)
        recyclerView.layoutManager = LinearLayoutManager(this)

        databaseHelper = DatabaseHelper(this)
        val listaRecetas = databaseHelper.getRecetasByTipo("Pasta")
