...
class BuscarRecetasArrozActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_buscar_recetas_arroz)

        recyclerView = findViewById(R.id.recyclerViewBuscarRecetasArroz)
        recyclerView.layoutManager = LinearLayoutManager(this)

        databaseHelper = DatabaseHelper(this)
        val listaRecetas = databaseHelper.getRecetasByTipo("Arroz")
