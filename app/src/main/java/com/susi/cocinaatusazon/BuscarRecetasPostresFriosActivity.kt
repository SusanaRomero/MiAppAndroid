...
class BuscarRecetasPostresFriosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_buscar_recetas_postres_frios)

        recyclerView = findViewById(R.id.recyclerViewBuscarRecetaPostresFrios)
