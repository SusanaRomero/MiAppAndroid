...
class CrearRecetaPanaderiaSaladaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_crear_receta_panaderia_salada)

        // Inicializar los elementos de la interfaz de usuario
        editTextNombreReceta = findViewById(R.id.editTextNombreRecetaPanaderiaSalada)
        editTextUtensilios = findViewById(R.id.editTextUtensiliosPanaderiaSalada)
        editTextTiempoAproximado = findViewById(R.id.editTextTiempoAproximadoPanaderiaSalada)
        editTextIngredientes = findViewById(R.id.editTextIngredientesPanaderiaSalada)
        editTextPreparacion = findViewById(R.id.editTextPreparacionPanaderiaSalada)
        editTextConsejos = findViewById(R.id.editTextConsejoPanaderiaSalada)
        imageViewFotoFinal = findViewById(R.id.imageViewFotoFinalPanaderiaSalada)
        buttonGuardarReceta = findViewById(R.id.buttonGuardarRecetaPanaderiaSalada)
    ...
    private fun guardarReceta() {
        ...
        if (nombre.isBlank() || utensilios.isBlank() || tiempoAproximado.isBlank() || ingredientes.isBlank() || preparacion.isBlank()) {
            ...
            if (result != -1L) {
                Toast.makeText(this, "Receta de panaderia salada guardada exitosamente", Toast.LENGTH_LONG).show()
            } else {
