...
class BuscarRecetasPanaderiaSaladaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_buscar_recetas_panaderia_salada)

        recyclerView = findViewById(R.id.recyclerViewBuscarRecetaPanaderiaSalada)
        recyclerView.layoutManager = LinearLayoutManager(this)

        databaseHelper = DatabaseHelper(this)
        val listaRecetas = databaseHelper.getRecetasByTipo("Panaderia Salada")
