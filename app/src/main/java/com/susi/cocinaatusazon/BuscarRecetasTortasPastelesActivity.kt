...
class BuscarRecetasTortasPastelesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_buscar_recetas_tortas_pasteles)

        recyclerView = findViewById(R.id.recyclerViewBuscarRecetaTortasPasteles)
        recyclerView.layoutManager = LinearLayoutManager(this)

        databaseHelper = DatabaseHelper(this)
        val listaRecetas = databaseHelper.getRecetasByTipo("Tortas y pasteles")
