...
class CrearRecetaPanaderiaDulceActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_crear_receta_panaderia_dulce)

        // Inicializar los elementos de la interfaz de usuario
        editTextNombreReceta = findViewById(R.id.editTextNombreRecetaPanaderiaDulce)
        editTextUtensilios = findViewById(R.id.editTextUtensiliosPanaderiaDulce)
        editTextTiempoAproximado = findViewById(R.id.editTextTiempoAproximadoPanaderiaDulce)
        editTextIngredientes = findViewById(R.id.editTextIngredientesPanaderiaDulce)
        editTextPreparacion = findViewById(R.id.editTextPreparacionPanaderiaDulce)
        editTextConsejos = findViewById(R.id.editTextConsejoPanaderiaDulce)
        imageViewFotoFinal = findViewById(R.id.imageViewFotoFinalPanaderiaDulce)
        buttonGuardarReceta = findViewById(R.id.buttonGuardarRecetaPanaderiaDulce)
    ...
    private fun guardarReceta() {
        ...
        if (nombre.isBlank() || utensilios.isBlank() || tiempoAproximado.isBlank() || ingredientes.isBlank() || preparacion.isBlank()) {
            ...
            if (result != -1L) {
                Toast.makeText(this, "Receta de panaderia dulce guardada exitosamente", Toast.LENGTH_LONG).show()
            } else {
