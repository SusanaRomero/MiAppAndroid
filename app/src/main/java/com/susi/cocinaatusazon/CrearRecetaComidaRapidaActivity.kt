...
class CrearRecetaComidaRapidaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_crear_receta_comida_rapidas)

        // Inicializar los elementos de la interfaz de usuario
        editTextNombreReceta = findViewById(R.id.editTextNombreRecetaComidaRapida)
        editTextUtensilios = findViewById(R.id.editTextUtensiliosComidaRapida)
        editTextTiempoAproximado = findViewById(R.id.editTextTiempoAproximadoComidaRapida)
        editTextIngredientes = findViewById(R.id.editTextIngredientesComidaRapida)
        editTextPreparacion = findViewById(R.id.editTextPreparacionComidaRapida)
        editTextConsejos = findViewById(R.id.editTextConsejoComidaRapida)
        imageViewFotoFinal = findViewById(R.id.imageViewFotoFinalComidaRapida)
        buttonGuardarReceta = findViewById(R.id.buttonGuardarRecetaComidaRapida)
    ...
    private fun guardarReceta() {
        ...
        if (nombre.isBlank() || utensilios.isBlank() || tiempoAproximado.isBlank() || ingredientes.isBlank() || preparacion.isBlank()) {
            ...
            if (result != -1L) {
                Toast.makeText(this, "Receta de comida rapida guardada exitosamente", Toast.LENGTH_LONG).show()
            } else {
